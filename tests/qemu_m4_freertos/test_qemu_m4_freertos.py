...
class TestQEMUM4FreeRTOSFirmwareAutoParse(unittest.TestCase):
    ...
    def test_pxCurrentTCB_non_null(self):
        ...
        pxCurrentTCB = self.elf_parser.parse_struct_auto('pxCurrentTCB', self.dump_reader)
    ...
    def test_tcb_struct_in_dwarf(self):
        ...
        self.assertEqual(tcb_struct.get('kind'), 'struct')
    ...
    def test_queue_struct_in_dwarf(self):
        ...
        self.assertEqual(queue_struct.get('kind'), 'struct')
    ...
    def test_baremetal_assert_data_intact(self):
        """Bare-metal assert_info / test_point / trace data still correct."""

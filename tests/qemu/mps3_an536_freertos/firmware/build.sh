...
PORT_DIR=$RTOS_DIR/portable/GCC/ARM_CR5
MEMMANG_DIR=$RTOS_DIR/portable/MemMang

CFLAGS="-mcpu=cortex-r52 -mthumb -mlittle-endian -mfloat-abi=soft \
...
LDFLAGS="-T linker.ld -Wl,--gc-sections -Wl,-Map,$IMG_DIR/test_firmware_freertos.map \
         -nostdlib -nostartfiles -mcpu=cortex-r52 -mthumb -mlittle-endian -mfloat-abi=soft"
